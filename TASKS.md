...
- [x] Inter font + JetBrains Mono
- [x] Custom CSS utilities (`.mn-panel-header`, `.mn-transcript-line`, `.mn-insight-card`)
- [x] Restyle mn-transcript (borderless, speaker labels, subtle borders)
- [x] Restyle mn-dashboard (two-panel layout, minimal navbar)
- [x] Restyle mn-insights (pill tabs, borderless cards)
- [x] Restyle mn-chat (custom input, speaker colors, suggestion chips)
- [x] Restyle mn-settings (grouped sections, collapsed Advanced, cleaner UX)
- [x] Restyle mn-compat-hints (subtle inline banner)
- [x] Restyle mn-status, mn-audio-level, mn-screen-captures, mn-history, mn-mcp
